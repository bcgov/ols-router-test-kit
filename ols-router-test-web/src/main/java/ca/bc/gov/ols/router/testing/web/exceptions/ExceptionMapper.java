...
public class ExceptionMapper {
	...
	public ResponseEntity<ErrorMessage> handleInvalidParameterException(InvalidParameterException ipe) {
		return new ResponseEntity<ErrorMessage>(ipe.getErrorMessage(),HttpStatus.BAD_REQUEST);
	}
